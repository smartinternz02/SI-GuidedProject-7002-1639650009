package com.anjana.expensetracker.controller;
...
import com.anjana.expensetracker.model.Balance;
import com.anjana.expensetracker.model.Categories;
import com.anjana.expensetracker.model.Expenses;
import com.anjana.expensetracker.model.User;
import com.anjana.expensetracker.repository.BalanceRepo;
import com.anjana.expensetracker.repository.ExpensesRepo;
import com.anjana.expensetracker.repository.UserRepository;
@Controller
...
public ModelAndView displayLogout(ModelAndView modelAndView, com.anjana.expensetracker.model.User user) {
	modelAndView.addObject("user", user);
	modelAndView.setViewName("login");
	return modelAndView;
}
